        ...
        if client.me.id in new_members:
            ...
            try:
                ...
                try:
                    ...
                    await message.reply_text(f"✅ <b>Main Bot (@{main_bot.username})</b> ကို Assistant မှ ထည့်သွင်းပေးလိုက်ပါပြီ။")
                except Exception as e:
                    await message.reply_text(f"⚠️ Main Bot ကို ထည့်မရပါ (Assistant Admin မဖြစ်နိုင်ပါ)။\nကျေးဇူးပြု၍ @{main_bot.username} ကို လူကိုယ်တိုင် ထည့်ပေးပါ။")
    except Exception as e:
        ...
        if member.new_chat_member.user.id == client.me.id:
            ...
            if member.new_chat_member.status == ChatMemberStatus.ADMINISTRATOR:
                ...
                try:
                    ...
                    await client.send_message(member.chat.id, f"✅ <b>Main Bot (@{main_bot.username})</b> ကို အလိုအလျောက် <b>Admin</b> ခန့်အပ်ပြီးပါပြီ။")
                except Exception as e:
